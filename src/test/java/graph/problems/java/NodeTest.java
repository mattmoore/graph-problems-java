...
class NodeTest {
    ...
    @Test void bfsTest() {
        ...
        assertEquals("Sergeant", BFS.search("Sergeant", commandStructure).value, "third level, first neighbor");
        assertEquals("Corporal", BFS.search("Corporal", commandStructure).value, "third level, second neighbor");
    }
}
